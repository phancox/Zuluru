...
$config['folders'] = array(
	...
	'league_base'		=> '/var/www/cakephp/zuluru/webroot/files',

	// The filesystem location where uploaded files go
	'uploads'			=> '/var/www/cakephp/zuluru/webroot/../upload',

	// The filesystem location where icon packs live.
	'icon_base'		=> '/var/www/cakephp/zuluru/webroot/img',
);
...
$config['urls'] = array(
	...
	'domain'			=> 'zuluru.sportzman.com.au',
